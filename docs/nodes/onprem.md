...
- **diagrams.onprem.aggregator.Fluentd** <img style="margin-left: 50px; width: 20px; height: 20px;" src="https://cdn.jsdelivr.net/gh/mingrammer/diagrams/resources/onprem/aggregator/fluentd.png">
- **diagrams.onprem.aggregator.Vector** <img style="margin-left: 50px; width: 20px; height: 20px;" src="https://cdn.jsdelivr.net/gh/mingrammer/diagrams/resources/onprem/aggregator/vector.png">
