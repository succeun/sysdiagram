		...
		fullscreen: {
			...
			css: {
				...
				".sysdiagram[data-sysdiagram-processed=true].fullscreen": {
					...
					"box-shadow": "0 1px 1px rgba(0,0,0,0.5), 0 2px 2px rgba(0,0,0,0.5), 0 4px 4px rgba(0,0,0,0.5), 0 8px 8px rgba(0,0,0,0.5), 0 16px 16px rgba(0,0,0,0.5), 0 32px 32px rgba(0,0,0,0.5)",
